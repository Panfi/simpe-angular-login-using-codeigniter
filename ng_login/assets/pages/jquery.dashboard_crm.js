...
!function($) {
    ...
    DashboardCRM.prototype.init = function() {
        ...
        this.createLineChart('morris-line-chart', $data, 'y', ['a', 'b'], ['Deal-Won ', 'Deal-Lost '],['0.1'],['#ffffff'],['#999999'], ['#483D8B', '#34d3eb']);
        ...
        this.createBarChart('morris-bar-chart', $barData, 'y', ['a', 'b'], ['Won Deals ', 'Lost Deals '], ['#483D8B', '#34d3eb']);
        ...
        this.createDonutChart('morris-donut-example', $donutData, ['#ebeff2','#483D8B', '#34d3eb']);
